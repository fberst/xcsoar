...
static constexpr MetaData meta_data[] = {
  ...
  // CYLINDERHEAD3_TEMPERATURE
  {
    N_("Cylinderhead3 temperature"),
    N_("CHT3"),
    N_("Shows the temperature of cylinderhead 3"),
    UpdateInfoBoxCHT3,
  },

  // CYLINDERHEAD4_TEMPERATURE
  {
    N_("Cylinderhead4 temperature"),
    N_("CHT4"),
    N_("Shows the temperature of cylinderhead 4"),
    UpdateInfoBoxCHT4,
  },
   ...
   // OIL_TEMPERATURE
  {
    N_("Oil temperature"),
    N_("Oil-temp"),
    N_("Shows the oil temperature"),
    UpdateInfoBoxOilTemperature,
  },

  // EXHAUST_TEMPERATURE
  {
    N_("Exhaust temperature"),
    N_("Exhaust-temp"),
  ...
  // WATER_TEMPERATURE
  {
    N_("Cooling water temperature"),
    N_("Water-temp"),
    N_("Shows the cooling water temperature"),
    UpdateInfoBoxWaterTemperature,
  },
  ...
  // OPERATING_HOURS
  {
    N_("Operating hours"),
    N_("OPH"),
    N_("Shows the Counter for operting hours"),
    UpdateInfoBoxOperatinghours,
  },
};

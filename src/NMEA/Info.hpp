...
struct NMEAInfo {
 ...
 /**
  ...
  /**
   * Temperature of Cylinderhead2 (if available)
   */
  fixed cht2;

  /**
   * Is temperature information of Cylinderhead2 available?
   */
  ...
  /**
   * Temperature of Cylinderhead4 (if available)
   */
  fixed cht4;

  /**
   * Is temperature information of Cylinderhead4 available?
   */
  Validity cht4_available;

  /**
   * Temperature of Oil(if available)
   */
  fixed oil_temp;

  /**
   * Is temperature of Oil available?
   */
  ...
  /**
   * External Voltage1 (if available)
   */
  fixed voltage1;

  /**
   * Is external Voltage1 available?
   */
  ...
  /**
   * State of Switch2 (if available)
   */
  bool switch2;

  /**
   * Is State of Switch2 available?
   */
  Validity switch2_available;

  /**
   * State of Switch3 (if available)
   */
  bool switch3;

  /**
   * Is State of Switch3 available?
   */
  Validity switch3_available;

  /**
   * State of Switch4 (if available)
   */
  bool switch4;

  /**
   * Is State of Switch4 available?
   */
  ...
  void ProvideSwitch2(bool value);
